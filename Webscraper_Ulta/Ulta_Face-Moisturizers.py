...
url= "https://www.ulta.com/skin-care-moisturizers?N=2796&No=0&Nrpp=48"
...
file_csv = csv.writer(open('Ulta_Face-Moisturizers_{}.csv'.format(date.today()), 'w'))
...
while counter < 1152:
    ...
    def product_content():
        ...
        try:
            print(brand, product, test_string, image_link, item_link)
    ...
    def next_page():
        global counter
        url = "https://www.ulta.com/skin-care-moisturizers?N=2796&No={}&Nrpp=48".format(counter)
        driver.get(url)
        counter += 48
        time.sleep(3)
    get_info()
