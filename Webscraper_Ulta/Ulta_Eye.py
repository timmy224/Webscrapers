...
url= "https://global.ulta.com/skin-care-eye-treatments?N=270k&No=0&Nrpp=48"
...
file_csv = csv.writer(open('Ulta_Eye-Treatments_{}.csv'.format(date.today()), 'w'))
...
while counter < 1152:
    ...
    def next_page():
        global counter
        url = "https://global.ulta.com/skin-care-eye-treatments?N=270k&No={}&Nrpp=48".format(counter)
        driver.get(url)
        counter += 48
        time.sleep(3)
    get_info()
