...
url= "https://www.ulta.com/korean-skin-care?N=27ig&No=0&Nrpp=48"
...
file_csv = csv.writer(open('Ulta_Korean-skincare_{}.csv'.format(date.today()), 'w'))
...
"""
check last page for counter www.ulta.com/korean-skin-care?N=27ig
""" 
while counter < 1152:
    def get_info():
    ...
    def next_page():
        global counter
        url = "https://www.ulta.com/korean-skin-care?N=27ig&No={}&Nrpp=48".format(counter)
        driver.get(url)
        counter += 48
        time.sleep(3)
    get_info()
