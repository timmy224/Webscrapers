...
url= "https://www.ulta.com/skin-care-treatment-serums?N=27cs&No=0&Nrpp=48"
...
file_csv = csv.writer(open('Ulta_Treatment-Serums_{}.csv'.format(date.today()), 'w'))
...
while counter < 1200:
    ...
    def next_page():
        global counter
        url = "https://www.ulta.com/skin-care-treatment-serums?N=27cs&No={}&Nrpp=48".format(counter)
        driver.get(url)
        counter += 48
        time.sleep(3)
    get_info()
