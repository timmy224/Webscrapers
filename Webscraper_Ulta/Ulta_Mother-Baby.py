...
url= "https://www.ulta.com/skin-care-mother-baby?N=2715&No=0&Nrpp=48"
...
file_csv = csv.writer(open('Ulta_Mother-Baby_{}.csv'.format(date.today()), 'w'))
...
"""
check last page for counter www.ulta.com/skincare-mother-baby?N=2715
""" 
while counter < 1152:
    def get_info():
    ...
    def product_content():
        ...
        time.sleep(5)
        try:   
            image_xpath = '//div[@class="s7staticimage"]//img[1]'
    ...
    def next_page():
        global counter
        url = "https://www.ulta.com/skin-care-mother-baby?N=2715&No={}&Nrpp=48".format(counter)
        driver.get(url)
        counter += 48
        time.sleep(3)
    get_info()
